...
<head>
    ...
    <link rel="stylesheet" href="../dist/pdfwind.css">
    <title>PDFWind</title>
</head>
...
<body class="mx-auto">
    <section>
        ...
        <div class="table">
            <?php foreach (['slate', 'gray', 'zinc', 'neutral', 'stone', 'red', 'orange', 'amber', 'yellow', 'lime', 'green', 'emerald', 'teal', 'cyan', 'sky', 'blue', 'indigo', 'violet', 'purple', 'fuchsia', 'pink', 'rose'] as $color) { ?>
                <div class="table-row">
                    <div class="table-cell w-20 capitalize"><?= $color ?></div>
                    <div class="table-cell pb-2">
                        <?php foreach ([50, 100, 200, 300, 400, 500, 600, 700, 800, 900] as $step) { ?>
                            <div class="text-center w-12 inline-block">
                                <div class="inline-block w-8 h-4 rounded bg-<?php echo $color . '-' . $step ?>">
                                    <div class="text-xs text-white h-4 align-middle"><?php echo $step ?></div>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="table-cell">
                        <?php foreach ([50, 100, 200, 300, 400, 500, 600, 700, 800, 900] as $step) { ?>
                            <div class="text-center inline-block">
                                <div class="inline-block rounded-sm text-<?php echo $color . '-' . $step ?>">
                                    Aa
                                </div>
                            </div>
                        <?php } ?>
        ...
        <div class="table">
            <?php foreach (['slate', 'gray', 'zinc', 'neutral', 'stone', 'red', 'orange', 'amber', 'yellow', 'lime', 'green', 'emerald', 'teal', 'cyan', 'sky', 'blue', 'indigo', 'violet', 'purple', 'fuchsia', 'pink', 'rose'] as $color) { ?>
                <div class="table-row">
                    ...
                    <div class="table-cell">
                        <?php foreach ([50, 100, 200, 300, 400, 500, 600, 700, 800, 900] as $step) { ?>
                            <div class="inline-block w-8 h-4 border border-<?php echo $color . '-' . $step ?>">
                            </div>
                        <?php } ?>
                    </div>
                </div>
...
&lt;/article&gt;
            ...
            <figure><img src="../src/photo-1556740758-90de374c12ad.jpeg" alt="">
  ...
  plugins: [],
    ...
    <section class="prose">
        ...
        <p class="font-sans">
        人皆生而自由；在尊嚴及權利上均各平等。人各賦有理性良知，誠應和睦相處，情同手足。 人皆生而自由；在尊嚴及權利上均各平等。人各賦有理性良知，誠應和睦相處，情同手足。 人皆生而自由；在尊嚴及權利上均各平等。人各賦有理性良知，誠應和睦相處，情同手足。
        </p>
